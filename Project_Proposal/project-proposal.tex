...
\begin{enumerate}
\item User opens up file browsing menu by left-clicking "Browse" (See Figure \ref{FileSearchMockup}).
...
\item User selects "Edit Keybindings" by left-clicking with the mouse.
