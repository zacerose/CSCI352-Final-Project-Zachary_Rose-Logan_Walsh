...
We used an abstract factory to provide different look-feel themes for the user to choose from (See Figure \ref{UML}). We also plan to implement a decorator to add special behavior to the button elements when needed.
