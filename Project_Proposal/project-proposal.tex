...
Why a media player?
We thought it would be interesting to make a tool that we might actually use, rather than some project for the sake of displaying some unusual programming concept. It will be good practice towards developing a user interface for a user-oriented application. 
...
\item UI scales with the window
\end{itemize}


\subsubsection{Non-Functional (Incomplete from here)}
\begin{itemize}
